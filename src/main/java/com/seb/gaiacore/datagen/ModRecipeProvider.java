...
//                .requires(ModBlocks.ENERGETIC_GAIA_CORE.get())
//                .unlockedBy(getHasName(ModBlocks.COFFEE_BLOCK.get()), has(ModBlocks.COFFEE_BLOCK.get()))
//                .save(pRecipeOutput, GaiaCore.MOD_ID + ":coffee_from_energetic_esoteric_core");
//
...
//                    .save(recipeOutput, GaiaCore.MOD_ID + ":" + getItemName(pResult) + pRecipeName + "_" + getItemName(itemlike));
//        }
//    }
}
